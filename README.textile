...
- @microdata@ :=
@true@ or @false@; initially set to @false@.
Adds @itemscope@ and the right @itemtype@ to the player wraptag (uses a @div@ if not provided) and adds a @meta@ tag declaring the @embedURL@ property right after the embedding code. =:
...
oui_soundcloud version 1.0.0-BETA2, Copyright (C) 2018 Nicolas Morand
...
* *oui_soundcloud v1.0.0-BETA2* (2018-07-05)
