h1. oui_player_soundcloud

h2. Introduction

"oui_player_soundcloud":https://github.com/NicolasGraph/oui_player_soundcloud is a "oui_player":https://github.com/NicolasGraph/oui_player v2+ extension to easily embed "Soundcloud":https://soundcloud.go.com/ provided player in "Textpattern":https://textpattern.com/ powered websites.
...
oui_player_soundcloud's minimum requirements:

* "Textpattern CMS":http://textpattern.com/ v4.6+;
* "oui_player":https://github.com/NicolasGraph/oui_player v2+;
* "oui_player_provider":https://github.com/NicolasGraph/oui_player_proivider v1+.
...
# "Download":https://github.com/NicolasGraph/oui_player_soundcloud/releases the compiled plugin file or the source to compile a customized file.
...
# Install oui_player_soundcloud:
@$ composer require oui/oui_player_soundcloud@
...
bc. $ composer update oui/oui_player_soundcloud
...
bc. $ composer remove oui/oui_player_soundcloud
...
oui_player_soundcloud version 1.0.0, Copyright (C) 2018 Nicolas Morand
...
* *oui_player_soundcloud v1.0.0-beta* (2018-06-24)
